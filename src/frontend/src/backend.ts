...
export class Backend implements backendInterface {
    ...
    async addDamageReport(arg0: DamageReportInput): Promise<DamageId> {
        if (this.processError) {
            try {
                const result = await this.actor.addDamageReport(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addPhotoToDamageReport(arg0: DamageId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPhotoToDamageReport(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addVehicle(arg0: string, arg1: string): Promise<VehicleId> {
        if (this.processError) {
            try {
    ...
    async getAllDamageReports(): Promise<Array<DamageReport>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllDamageReports();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllDamagesForVehicle(arg0: VehicleId): Promise<Array<DamageReport>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllDamagesForVehicle(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAvailableVehicles(arg0: string): Promise<Array<Vehicle>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAvailableVehicles(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOpenDamages(): Promise<Array<DamageReport>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOpenDamages();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getReportsByStatus(arg0: string): Promise<Array<DamageReport>> {
        if (this.processError) {
            try {
                const result = await this.actor.getReportsByStatus(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getReportsByUser(arg0: Principal): Promise<Array<DamageReport>> {
        if (this.processError) {
            try {
    ...
    async getReportsForVehicle(arg0: VehicleId): Promise<Array<DamageReport>> {
        if (this.processError) {
            try {
                const result = await this.actor.getReportsForVehicle(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getVehicleById(arg0: VehicleId): Promise<Vehicle> {
        if (this.processError) {
            try {
    ...
    async removeVehicle(arg0: VehicleId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateDamageReportStatus(arg0: DamageId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateDamageReportStatus(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
